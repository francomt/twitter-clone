...
const Tweet = ({ tweet, me, deleteTweet, likeTweet }) => {
  ...
  // useEffect(() => {
  //   const trueOrFalse = tweet.userLikes.some((user) => {
  //     return user.id === me.id;
  //   });

  //   setLiked(trueOrFalse);
  // }, []);
  ...
  return (
    <div className="tweet">
      ...
      <div className="tweet__container">
        <img
          src={`/img/users/${tweet.user.photo}`}
          onClick={() => {
        ...
        <div className="content">
          ...
          <div className="content__shares">
            {liked ? (
              <div
                className="content__like-container liked"
                onClick={() => {
                  console.log("CLICKED");
                }}
              >
              ...
              <div
                className="content__like-container unliked"
                onClick={() => {
                  likeTweet(tweet.id);
                }}
              >
