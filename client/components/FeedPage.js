  ...
  handleInputChange(e){
    ...
    if (!query) {
      ...
      this.setState({query, loading: true, message: ""}, ()=> {
        ...
        console.log(this.state.query, this.state.results)
      })
    }
  }
  ...
  render() {
    ...
    <div className="feed-page-container">
      <nav className="secondary-nav">
        ...
        <input onChange={this.handleInputChange} className="searchbar util-margin-auto-left util-margin-right-large" placeholder="Search Twitter"></input>
      </nav>
